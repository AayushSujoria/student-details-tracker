...
{
if(((strlen(reg)==10)&&isdigit(reg[0]))&&(isdigit(reg[3]))&&(isdigit(reg[4]))&&(isdigit(reg[7]))&&(isdigit(reg[8]))&&(isdigit(reg[9]))&&(isAlpha(reg[1]))&&(isAlpha(reg[2]))&&(isAlpha(reg[5]))&&(isAlpha(reg[6])))
...
void student::seqdisp()
{
	...
	fstream file("student.dat",ios::in);
	file.seekg(0,ios::beg);
	cout<<setiosflags(ios::left)<<setw(15)<<"ID"<<setw(25)<<"Name"<<setw(20)<<"Address";
...
int main ()
{
   ...
   clrscr();
	...
	do
	{
	  ...
	  cout<<"******************************************";gotoxy(18,8);
	  cout<<"* 1: Display all student records";gotoxy(59,8);cout<<"*";gotoxy(18,10);
	...
	//   cout<<"* 7: Entry Sequence display";gotoxy(59,20);cout<<"*";gotoxy(18,22);
	  cout<<"* 7: Quit program";gotoxy(59,22);cout<<"*";gotoxy(18,24);
	  cout<<"******************************************"<<endl;
	  cout<<"\n\t\t Enter choice [1-8] : ";
	 cin>>ch;
	 int aniket = 0 ;
